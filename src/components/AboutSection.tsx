      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
          ...
          >
            <motion.div variants={itemVariants}>
              ...
              <p className="text-muted-foreground">
                ...
                React Native. With a strong foundation in frontend technologies,
                I build scalable, user-focused applications and deliver
          ...
          >
            ...
            >
              <h3 className="text-2xl font-bold">Sajawal Chohan</h3>
            ...
            >
              <Button className="gap-2" asChild onClick={handledownload}>
                <a href='#' download="Sajawal_Chohan_CV.pdf">
